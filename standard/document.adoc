...
:affiliation_2: Office of XXXX, First Operating Unit
...
:doi: https://doi.org/10.6028/NIST.SP.800-xxxx
:comment: ### URI to which this document is published, which is not a DOI
:uri: http://example.com/NIST.SP.800-xxxx
...
:status: draft-prelim
:comment: ### Include the Call for Patent Claims in document drafts, and the Patent Disclosure Notice in finalised documents. See comment 6 below. Omit if not applicable
:call-for-patent-claims:
:comment: ### Indicate in the Patent Disclosure Notice that notice and commitment to license have been received. See comment 6 below. Omit if not applicable
:commitment-to-licence:
:comment: ### Contact email for inquiries about patents. See comment 7 below
...
:comment: ### Omit unless retired or withdrawn draft. See comment 8 and comment 9 below.
...
////
Comment 6: Call for Patent Claims, Patent Disclosure Notice (:call-for-patent-claims:, :commitment-to-licence:)

[Effective January 1, 2019] Draft Publications:  If a draft SP 800 contains guidance and/or requirements, then -- per Section 3 of the ITL Policy: Inclusion of Patents in ITL Publications, https://www.nist.gov/itl/information-technology-laboratory-itl-patent-policy-inclusion-patents-itl-publications --  a Call for Patent Claims shall be included in the document. This is included only in the Draft, and is automaticaly omitted in the final publication.

Policy: https://www.nist.gov/itl/information-technology-laboratory-itl-patent-policy-inclusion-patents-itl-publications 
This policy has been drafted and reviewed by ITL management and the Chief Counsel for NIST.

An FAQ is available at https://inet.nist.gov/itl/frequently-asked-questions-itl-patent-policy-inclusion-patents-itl-publications. 

[Effective January 1, 2019] Final Publications:  If a Call for Patent Claims was included in the Draft Publication, then -- per Section 5 of the ITL Policy: Inclusion of Patents in ITL Publications, https://www.nist.gov/itl/information-technology-laboratory-itl-patent-policy-inclusion-patents-itl-publications -- a Patent Disclosure Notice shall be included. The Patent Disclosure Notice is formulated differently depending on whether notice and commitment to license have been received by ITL at the time of publication (Option 1), or no notice and commitment to license have been received by ITL at the time of publication (Option 2). Option 1 is indicated by setting the :commitment-to-licence: document attribute; Option 2 is indicated by omitting the :commitment-to-licence: document attribute.
////

////
Comment 7: ITL point of contact (:patent-contact:)

This may be an email address for the publication, or an individual's name, email, and/or phone.  I suggest using the same email alias to which public comments are sent, e.g., 

sp800-333-comments@nist.gov, with the Subject: "SP 800-333 Call for Patent Claims"
////
...
////
Comment 9: Withdrawn drafts and publications (:circulated-date:, :published-date:, :obsoleted-date:, :obsoleted-by:,
:superseding-status:, :superseding-iteration:, :superseding-title:,
:superseding-circulated-date:, :superseding-doi:, :superseding-url:, :bib-additional-note:)
...
the cover page will display information about the document superseding it. This information must be
provided as document attributes: :published-date: (when this draft was first published),
:obsoleted-date: (the date on which this draft was superseded), and optionally a note with additional information
(:bib-additional-note:). If information about the superseding document is available from the CSRC
website, it can be retrieved by giving the identifier of the superseding document, as
:obsoleted-by:. If that information is not available from the CSRC website, it needs to
be provided through the various :superseding- attributes.
...
include::sections/00d-executivesummary.adoc[]
