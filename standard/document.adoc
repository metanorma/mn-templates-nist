...
:comment: ### Omit unless withdrawn draft. See comment 9 below
...
:comment: ### Omit unless withdrawn draft, and the superseding document has a distinct title. See comment 9 below
...
:comment: ### Omit unless withdrawn draft, and the superseding document has a DOI. See comment 9 below
:superseding-doi: final
:comment: ### Omit unless withdrawn draft, and the superseding document has a URL. See comment 9 below
...
////
Comment 9: Withdrawn drafts (:circulated-date:, :obsoleted-date:,
...
provided as document attributes: :obsoleted-date: (the date on which this draft was superseded),
